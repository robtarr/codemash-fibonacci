...
CPPPATH_NODE = '/usr/local/Cellar/node/0.8.2/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-Wall', '-O3']
...
LIBDIR = '/Users/justin/.node_libraries'
LIBPATH_HIREDIS = '../deps/hiredis'
LIBPATH_NODE = '/usr/local/Cellar/node/0.8.2/lib'
LIBPATH_ST = '-L%s'
LIB_HIREDIS = 'hiredis'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/justin/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr/local/Cellar/node/0.8.2'
